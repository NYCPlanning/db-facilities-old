...
psql -U $DBUSER -d $DBNAME -f ./2_assembly/insert/dsny_facilities_foodscrapdropoffsites.sql
...
psql -U $DBUSER -d $DBNAME -f ./2_assembly/insert/hra_idnyc_locations.sql
psql -U $DBUSER -d $DBNAME -f ./2_assembly/insert/hra_facilities_centers.sql
psql -U $DBUSER -d $DBNAME -f ./2_assembly/insert/nycha_facilities_communitycenters.sql
...
psql -U $DBUSER -d $DBNAME -f ./2_assembly/insert/otm_mentalhealthservicefinder.sql

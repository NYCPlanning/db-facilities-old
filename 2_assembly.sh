...
psql -U $DBUSER -d $DBNAME -f ./2_assembly/config_doe_facilities_lcgms.sql
...
psql -U $DBUSER -d $DBNAME -f ./2_assembly/standardize_group.sql
psql -U $DBUSER -d $DBNAME -f ./2_assembly/standardize_domain.sql

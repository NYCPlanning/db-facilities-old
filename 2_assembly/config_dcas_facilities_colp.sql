...
SELECT
	...
	-- facilitygroup
		(CASE
			...
			WHEN usedec LIKE '%EARLY CHILDHOOD%' THEN 'Day Care and Pre-Kindergarten'
			WHEN usedec LIKE '%DAY CARE%' THEN 'Day Care and Pre-Kindergarten'
			WHEN agency LIKE '%ACS%' AND usedec LIKE '%RESIDENTIAL%' THEN 'Child Services and Welfare'
			WHEN agency LIKE '%ACS%' THEN 'Day Care and Pre-Kindergarten'

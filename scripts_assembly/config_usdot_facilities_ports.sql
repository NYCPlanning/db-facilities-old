...
SELECT
	...
	(CASE
		...
		WHEN operators like '%Corrections%' THEN 'New York City Department of Correction'
		...
		WHEN operators IS NULL AND owners like '%Corrections%' THEN 'New York City Department of Correction'
	...
	ARRAY[(CASE
		...
		WHEN owners like '%Corrections%' THEN 'New York City Department of Correction'
